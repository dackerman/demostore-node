...
[![NPM version](https://img.shields.io/npm/v/@dackerman/demostore.svg)](https://npmjs.org/package/@dackerman/demostore) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@dackerman/demostore)
...
```sh
npm install @dackerman/demostore
```
...
To do the inverse, add `import "@dackerman/demostore/shims/node"` (which does import polyfills).
