...
import { ClientOptions } from '@dackerman-stainless/demostore';
...
export { ClientOptions } from '@dackerman-stainless/demostore';
...
export function initMcpServer(params: {
  ...
  const client = new StainlessStore(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
